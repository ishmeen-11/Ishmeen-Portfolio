...
(function () {
    ...
    // ==========================================================================
    // 📜 ABSTRACT & BIBTEX MODAL SYSTEM
    // ==========================================================================
    var papersData = [
        {
            title: "Emerging Applications and Challenges in Quantum Computing: A Literature Survey",
            abstract: "This literature survey explores the landscape of quantum computing applications, identifying critical challenges such as decoherence, error correction, and scalability, while highlighting emerging opportunities across optimization, cryptography, and molecular simulation.",
            bibtex: "@article{garewal2024quantum,\n  title={Emerging Applications and Challenges in Quantum Computing: A Literature Survey},\n  author={Garewal, Ishmeen and others},\n  journal={IEEE Xplore},\n  year={2024}\n}"
        },
        {
            title: "Topic Modeling for Identifying Emerging Trends on Instagram Using LDA and NMF",
            abstract: "Identifies emerging visual and textual themes on Instagram using Latent Dirichlet Allocation (LDA) and Non-Negative Matrix Factorization (NMF), comparing performance and validating cluster coherence over dynamic temporal datasets.",
            bibtex: "@inproceedings{garewal2024topic,\n  title={Topic Modeling for Identifying Emerging Trends on Instagram Using LDA and NMF},\n  author={Garewal, Ishmeen and others},\n  booktitle={IEEE Xplore},\n  year={2024}\n}"
        },
        {
            title: "Blockchain-Based Smart Contracts for Decentralized Vehicle-to-Grid (V2G) Load Management",
            abstract: "Proposes a decentralized load management network for Vehicle-to-Grid (V2G) power transfers using Solidity smart contracts on the Ethereum blockchain, securing financial transactions and automating grid peak balancing.",
            bibtex: "@article{garewal2025blockchain,\n  title={Blockchain-Based Smart Contracts for Decentralized Vehicle-to-Grid (V2G) Load Management},\n  author={Garewal, Ishmeen and others},\n  journal={IEEE Xplore},\n  year={2025}\n}"
        },
        {
            title: "FoodMO: A Food Nutrient Analysis Application Using OCR and Machine Learning",
            abstract: "Presents the design of FoodMO, a mobile health app using Optical Character Recognition (OCR) to extract nutritional facts from retail packaging and Random Forest classifiers to predict health scores, suggesting healthier dietary alternatives.",
            bibtex: "@incollection{garewal2024foodmo,\n  title={FoodMO: A Food Nutrient Analysis Application Using OCR and Machine Learning},\n  author={Garewal, Ishmeen and others},\n  booktitle={Springer LNNS},\n  year={2024}\n}"
        },
        {
            title: "Natural Language Processing: A Survey of Approaches, Applications, and Future Directions",
            abstract: "A comprehensive review of modern Natural Language Processing techniques, covering rule-based models, statistical methods, transformers, large language models (LLMs), and future directions in multimodal understanding.",
            bibtex: "@article{garewal2025nlp,\n  title={Natural Language Processing: A Survey of Approaches, Applications, and Future Directions},\n  author={Garewal, Ishmeen and others},\n  journal={IEEE Xplore},\n  year={2025}\n}"
        }
    ];

    var modal = $("#paperModal");
    var modalTitle = $("#modalTitle");
    var modalAbstract = $("#modalAbstract");
    var modalBibtex = $("#modalBibtex");
    var btnCopy = $("#btnCopyBibtex");
    ...
    window.openPaperModal = function (index) {
        ...
        modalBibtex.textContent = paper.bibtex;
    ...
    var closeOverlay = $("#modalCloseOverlay");
    if (closeBtn) closeBtn.addEventListener("click", window.closePaperModal);
    if (closeOverlay) closeOverlay.addEventListener("click", window.closePaperModal);
    ...
    if (btnCopy) {
        btnCopy.addEventListener("click", function () {
            var text = modalBibtex.textContent;
